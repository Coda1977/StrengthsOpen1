...
## Recent Changes
- June 24, 2025: Fixed "New Chat" button functionality to immediately open chat interface, clear all state, hide sidebar on mobile, auto-focus input field, and provide user feedback notification
